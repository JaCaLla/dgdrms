...
struct ColorsDgdrms {
    ...
    // MARK: - ShopPrice
    struct ShopPrice {
        static let PricesFoundBackground = ColorsDgdrms.Interface.ColorWhiteAlpha05
        static let PricesFound = ColorsDgdrms.Interface.ColorWhite
    }

    struct ProductPrices {
        static let PriceFontColor = ColorsDgdrms.Interface.ColorWhite
        static let DistanceFontColor = ColorsDgdrms.Interface.ColorWhite
        static let ShopFontColor = ColorsDgdrms.Interface.ColorWhite
        static let SelectorFontColor = ColorsDgdrms.Interface.ColorWhite
        static let DistanceSelectorColor = ColorsDgdrms.Interface.ColorWhiteAlpha05
    }
}
